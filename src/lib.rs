...
use crate::instructions::{
    ...
    SettleMarket, StakeOutcomeToken, UnstakeOutcomeToken, UpdateConfig, WithdrawTreasury,
};
...
pinocchio::address::declare_id!("E8ApH1v8MJMgjQ8dDFyuaS95u7iW64cWhDBa8ENZ34E7");
